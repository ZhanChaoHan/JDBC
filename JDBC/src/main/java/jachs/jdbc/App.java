...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		Connection connection = DriverManager.getConnection(pro.getProperty("url"), pro.getProperty("user"),
				pro.getProperty("password"));
		System.out.println(connection.getAutoCommit());// 是否自动提交
		System.out.println(connection.getCatalog());// 选中那个数据库
...
//			while(colRet.next()) { 
//				columnName = colRet.getString("COLUMN_NAME"); //字段名称
//				columnType = colRet.getString("TYPE_NAME"); //字段类型
//				int datasize = colRet.getInt("COLUMN_SIZE"); //字段长度
//				int digits = colRet.getInt("DECIMAL_DIGITS"); //
//				int nullable = colRet.getInt("NULLABLE"); 
//				System.out.println(columnName+" "+columnType+" "+datasize+" "+digits+" "+ nullable); 
//			}
//			ResultSet primaryKeyResultSet = metaData.getPrimaryKeys(catalog(),null,tables.getString("TABLE_NAME"));  
//			while(primaryKeyResultSet.next()){  
//			    String primaryKeyColumnName = primaryKeyResultSet.getString("COLUMN_NAME");  
//			    System.out.println(tables.getString("TABLE_NAME")+"\t主键:\t\t"+primaryKeyColumnName);
//			}
			ResultSet foreignKeyResultSet = metaData.getImportedKeys(catalog(),null,tables.getString("TABLE_NAME"));  
			while(foreignKeyResultSet.next()){  
			    ...
			    System.out.println(fkColumnName+"\t\t"+pkTablenName+"\t\t"+pkColumnName);
			}  
		}
